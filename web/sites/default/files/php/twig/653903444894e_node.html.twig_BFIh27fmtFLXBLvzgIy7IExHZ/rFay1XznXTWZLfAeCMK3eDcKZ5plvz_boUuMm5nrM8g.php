...
/* themes/custom/neith/templates/content/node.html.twig */
class __TwigTemplate_b36cfdb681b2d59226973113c2745b37 extends Template
{
    private $source;
    private $macros = [];
...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 77, $this->source)))) : (""))];
        // line 80
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->attachLibrary("neith/node"), "html", null, true);
        echo "
<article";
        // line 81
...
";
    ...
    {
        return "themes/custom/neith/templates/content/node.html.twig";
    }
    ...
    {
        return new Source("", "themes/custom/neith/templates/content/node.html.twig", "/var/www/html/web/themes/custom/neith/templates/content/node.html.twig");
    }
