...
class BackgroundImageViewBuilder extends EntityViewBuilder {
   ...
   *   The token service.
   */
  public function __construct(EntityTypeInterface $entity_type, EntityRepositoryInterface $entity_repository, LanguageManagerInterface $language_manager, Registry $theme_registry, ThemeManagerInterface $themeManager, EntityDisplayRepositoryInterface $entity_display_repository, FileUrlGeneratorInterface $fileUrlGenerator, StateInterface $state, Token $token) {
