...
class BackgroundImageManager implements BackgroundImageManagerInterface {
  ...
  public function cacheFlush() {
    ...
    if (file_exists($bg_dir_uri)) {
      $this->fileSystem->scanDirectory($bg_dir_uri, '/.*/', ['callback' => function ($uri) {
        try {
      ...
      !$this->fileSystem->mkdir($bg_dir_uri, NULL, TRUE);
    }
  }
